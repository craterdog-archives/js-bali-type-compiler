...
/*
    $tag: #GT6VJCN79H0GRF4Y83QXYT2P1530DA9S
    $digest: 3CALFQ2Q6PD99YW9Q56KHWCNNRRD614P85VBYF0MHD6B3X3AHG1TC76JZMS2J55B05TRTZHAKF9VRWH7VZPRP4JX87VDP5CH6FP7S98
...
function loadTask(filename) {
    ...
    var literals = bali.list([
        ...
        5,
        "<bali:[]>",
        "<bali:[$protocol:v1,$tag:#GT6VJCN79H0GRF4Y83QXYT2P1530DA9S,$version:v1,$digest:'3CALFQ2Q6PD99YW9Q56KHWCNNRRD614P85VBYF0MHD6B3X3AHG1TC76JZMS2J55B05TRTZHAKF9VRWH7VZPRP4JX87VDP5CH6FP7S98']>",
        bali.parse('[$foo: "bar"](\n' +
        "    <bali:[$protocol:v1,$tag:#GT6VJCN79H0GRF4Y83QXYT2P1530DA9S,$version:v1,$digest:'3CALFQ2Q6PD99YW9Q56KHWCNNRRD614P85VBYF0MHD6B3X3AHG1TC76JZMS2J55B05TRTZHAKF9VRWH7VZPRP4JX87VDP5CH6FP7S98']>\n" +
        ')'),
        '$foo',
